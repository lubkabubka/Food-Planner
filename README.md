# Планировщик раскладки продуктов для похода (простой, без сложной оптимизации)
...
Проект максимально простой и весь в одном скрипте `src/assign.py` с комментариями.# Food-Planner
